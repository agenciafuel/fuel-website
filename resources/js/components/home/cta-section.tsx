        ...
        <section id="cta" className="relative flex flex-col justify-end overflow-hidden bg-black pb-6 pt-16 md:pt-28 lg:pt-36">
            <div className="relative z-20 mx-auto w-full max-w-7xl px-5 md:px-12 lg:px-20">
                <div className="flex w-full flex-col items-start gap-8 md:flex-row md:items-start md:justify-between">
                    <div className="w-full text-right md:max-w-3xl md:text-left">
                        <h2 className="font-roboto text-[32px] leading-[1] text-white md:text-[36px] lg:text-[66px]">
                            <span className="font-bold text-white">adoraríamos</span>
                            <br />
                            <span className="font-bold text-white">trabalhar</span>
                            <br />
                            <span className="font-light italic text-[#E30613]">com você</span>
                            <br />
                            <span className="font-light italic text-[#E30613]">e seu time.</span>
                        </h2>
                    </div>

                    <div className="hidden shrink-0 md:block">
                        <div className="flex flex-col gap-2 pt-4 text-right text-[#c9c9c9]">
                            <span>+55 18 3908 9288</span>
                            <span>Rua José Leite, 76 - Jardim Bongiovani, 19053 240</span>
                ...
                <div className="mt-8 flex justify-end md:mt-12 md:justify-start">
                    <a
                        href="#contato"
                        className="inline-flex items-center rounded-full bg-[#E30613] px-6 py-2 font-roboto text-[10px] font-bold tracking-wide text-white transition-all duration-300 hover:bg-[#c8061f] md:py-3 md:text-xl lg:px-8"
                    >
                        fale com a gente
                    </a>
                </div>
                ...
                <div className="mt-12 md:hidden">
                    <div className="flex flex-col gap-1 font-roboto text-[9px] leading-[1.6] text-white">
                        ...
                        <span>Rua José Leite, 76 - Jardim Bongiovani, 19053 240</span>
                        <span>Pres. Prudente / SP - Brasil</span>
                        <span>Rubens Uer Torossian Torres Junior - ME</span>
                        <span>CNPJ: 24.693.652/0001-26</span>
            ...
            <div className="relative z-20 mx-auto mt-12 flex w-full max-w-7xl flex-col items-start gap-10 px-5 md:mt-24 md:flex-row md:items-end md:justify-between md:px-12 lg:px-20">
                ...
                <div className="flex items-center gap-2">
                    <span className="font-roboto text-[11px] text-white/90">

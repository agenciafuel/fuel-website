        ...
        >
            ...
            <div className="relative z-20 mx-auto max-w-7xl px-5 md:px-12 lg:px-20">
                ...
                <article
                    ...
                    style={{
                        backgroundImage:
                            'linear-gradient(to right, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.3) 50%, rgba(0,0,0,0.85) 100%), url("https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&q=80&w=2000")',
                    }}
                >
                    ...
                    <div className="absolute top-8 right-8 md:top-10 md:right-14 lg:top-20 lg:right-20">
                        <span className="font-roboto text-[12px] text-white md:text-2xl">
                            <span className="font-bold">11/12</span> - publicado
                    ...
                    <div className="relative z-10 w-full lg:w-[65%]">
                        <h3 className="font-roboto text-[32px] leading-none font-bold text-white md:text-[45px] lg:text-[75px]">
                            Como funcionam
                            <br />
                            as etapas para
                            <br />
                ...
                <div className="mt-4 grid grid-cols-2 gap-4 md:mt-6 md:grid-cols-3 md:gap-6">
                    {[1, 2, 3].map((item, index) => (
                        <article
                            ...
                            style={{
                                backgroundImage:
                                    'linear-gradient(to top, rgba(0,0,0,0.95) 0%, rgba(0,0,0,0.2) 60%, rgba(0,0,0,0.4) 100%), url("https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&q=80&w=800")',
                            }}
                        >
                            <div className="relative z-10 w-full">
                                <h3 className="font-roboto text-[11px] leading-[1.2] font-bold text-white md:text-[14px] lg:text-[16px]">
                                    Como funcionam
                                    <br />
                                    as etapas para
                                    <br />

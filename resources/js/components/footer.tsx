            ...
            <div className="relative z-20 mx-auto w-full max-w-7xl px-5 md:px-12 lg:px-20">
                <div className="flex w-full flex-col items-start gap-8 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="hidden shrink-0 md:block">
                        <div className="flex flex-col gap-2 pt-4 text-right text-white text-lg">
                            <span>+55 18 3908 9288</span>
                            <span>Rua José Leite, 76 - Jardim Bongiovani</span>
                            <span>Centro, 19053 240</span>
                ...
                <div className="mt-8 flex justify-end md:mt-12 md:justify-start">
                    <a
                        href="#contato"
                        className="inline-flex items-center rounded-full bg-fuel-bg-red px-2 py-2 font-roboto text-[10px] font-bold tracking-wide text-white transition-all duration-300 hover:bg-fuel-bg-red md:py-3 md:text-xl lg:px-8"
                    >
                       envie uma mensagem
                    </a>
                </div>

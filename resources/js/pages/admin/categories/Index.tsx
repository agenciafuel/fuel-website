            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">{data.length} categoria{data.length !== 1 ? 's' : ''}</p>
                    </div>
                        ...
                        <tbody>
                            {data.map((item: any) => (
                                <tr key={item.id} className="border-b border-border/50 transition-colors last:border-0 hover:bg-accent/50">
                                    ...
                                    <td className="px-5 py-4 text-sm text-muted-foreground">{item.slug}</td>
                            ...
                            {data.length === 0 && (
                                <tr><td colSpan={4} className="px-5 py-12 text-center text-muted-foreground">Nenhuma categoria cadastrada ainda.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
